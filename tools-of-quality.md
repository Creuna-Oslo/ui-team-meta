...
Work is derived from issues on the issue tracker. Team members suited to perform the work then assign themselves work instead of work being prescribed to specific members, creating a [pull based workflow](https://leankit.com/learn/kanban/kanban-pull-system/) instead of a push based one. This eliminates administration of who does what, and removes a potential bottleneck, freeing time for other activities.
